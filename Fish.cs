...
namespace polyinherit
{
    class Fish : Animal // Derived class (child). use the ":" in order to inherit from the class "Animal"
    {
        ...
        public override void animalLimbs() //"Derived_Class.animalLimbs() hides the inherited memeber Animal.animalLimbs(). To make the current member override that implementation,
        {
